...
<template>
  <div>
    <nav
      class="bg-slate-600 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-gray-200 dark:border-gray-600"
    >
      <div class="flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center md:order-2 border-gray-400 rounded-[100px]">
          <div class="relative">
            <button
              type="button"
              class="flex mr-3 text-sm rounded-full md:mr-0 focus:ring-2 focus:ring-gray-300"
              id="user-menu-button"
              aria-expanded="false"
            ...
            <div v-if="showDropdown" @click.away="showDropdown = false">
              <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg">
                <a href="https://pipeline-pingpong-adminportal-dev-as.azurewebsites.net"
...
import { myMSALObj, graphScopes, msalConfig } from '../stores/auth.store'
